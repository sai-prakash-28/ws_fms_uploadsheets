...
<head>
    <meta charset="UTF-8">
    <title>error in feedback system</title>
    <style>
        body,
        html {
            padding: 0;
...
<body>
    ...
    <div class="container">
        <div class="error">
            <h1>500</h1>
            <h2>error</h2>
            <p>Hmm!!!, something just isn't right... Dont worry we are about to put out best man on work.</p>
            <br>
            <p>*before that please make sure the columns are with correct headerand values respectively</p>
        </div>
            ...
            if (e.animationName === 'explode') {
                cardNodes.forEach(function (elem, index) {
                    ...
                    elem.addEventListener('click', function () {
                        ...
                        elem.style.transform = `translate(80px, 80px) rotate(-540deg)`
